...
public abstract class ButtonBase extends JButton implements IComponenteBase {
	...
	public ButtonBase(Action a, final Container contenitore) {
		super(a);
		this.contenitorePadre = contenitore;
		init(contenitorePadre, this);
	}

	public ButtonBase(Icon icon,final Container contenitore) {
		super(icon);
		this.contenitorePadre = contenitore;
		init(contenitorePadre, this);
	}

	public ButtonBase(String text, Icon icon,final Container contenitore) {
		super(text, icon);
		this.contenitorePadre = contenitore;
		init(contenitorePadre, this);
	}

	public ButtonBase(String text,final Container contenitore) {
		super(text);
		this.contenitorePadre = contenitore;
		init(contenitorePadre, this);
	}
